...
d_model = config['train_config']['d_model']
nhead = config['train_config']['nhead']
num_encoder_layers = config['train_config']['num_encoder_layers']
dropout= config['train_config']['dropout']
dim_feedforward=config['train_config']['dim_feedforward']
...
class TransformerTimeSeries(nn.Module):
    ...
    def __init__(self, num_features, seq_len, num_targets, d_model=d_model, nhead=nhead, num_encoder_layers=num_encoder_layers, dropout=dropout, dim_feedforward= dim_feedforward):
