...
from competitor_knas import *
from competitor_ecnas import *
...
def start_exp(
    ...
    Args:
        ...
        competitors (str): Name of the competitors to run, choice into max, balanced, knas.
    ...
    if competitors == "max" or competitors == "balanced":
        ...
        m_name = f'{competitors}_nasbench101'
    elif competitors == "knas":
        model = KNAS(lr=lr)
        m_name = f'{competitors}'
    elif competitors == 'None':
        raise ValueError("Please introduce at lest one competitor!")
    else:
        raise ValueError(f"Competitors {competitors} not available")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="None",
        help="Name of the competitors to run, choice into max, balanced, knas",
    )
