...
if __name__ == '__main__':
    ...
    print(f'old len {len(train_dataset)}')
    train_dataset = ConcatDataset([train_dataset, train_dataset])
    print(f'new len {len(train_dataset)}')
    ...
    trainer= pl.Trainer(max_epochs=32, log_every_n_steps=10, callbacks=[early_stopping_callback, checkpoint_callback], logger=True)
    # Train the model
